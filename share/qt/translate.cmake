...
function(extract_strings output)
  ...
  file(STRINGS "lambdaniostrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *lambdanio_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"lambdanio-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/lambdaniostrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/lambdaniostrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/lambdanio_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/lambdanio_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/lambdanio_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/lambdanio_en.xlf" lambdanio_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" lambdanio_en "${lambdanio_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" lambdanio_en "${lambdanio_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/lambdanio_en.xlf" "${lambdanio_en}")
