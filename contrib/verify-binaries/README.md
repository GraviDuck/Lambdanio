...
As of Lambdanio Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/lambdanio-core/guix.sigs/). When
...
builder-keys](https://github.com/lambdanio-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://lambdaniocore.org and https://lambdanio.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/lambdanio-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/lambdanio-24.0.1-arm-linux-gnueabihf.tar.gz
```
