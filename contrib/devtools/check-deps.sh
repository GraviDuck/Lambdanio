...
declare -A LIBS
LIBS[cli]="liblambdanio_cli.a"
LIBS[common]="liblambdanio_common.a"
LIBS[consensus]="liblambdanio_consensus.a"
LIBS[crypto]="liblambdanio_crypto.a"
LIBS[node]="liblambdanio_node.a"
LIBS[util]="liblambdanio_util.a"
LIBS[wallet]="liblambdanio_wallet.a"
...
# https://github.com/lambdanio/lambdanio/issues/10102
