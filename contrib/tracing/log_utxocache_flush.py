...
"""Example logging Lambdanio Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of lambdaniod>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[lambdaniod_with_usdts])
