...
complete --command lambdaniod --no-files

# Extract options
function __fish_lambdaniod_get_options
...
complete \
    --command lambdaniod \
    --arguments "(__fish_lambdaniod_get_options --nofiles)"
