...
# Extract options
function __fish_lambdanio_tx_get_options
...
# Extract commands
function __fish_lambdanio_tx_get_commands
...
# Add options
complete \
    --command lambdanio-tx \
    --condition "not __fish_lambdanio_seen_cmd (__fish_lambdanio_tx_get_commands --commandsonly)" \
    --arguments "(__fish_lambdanio_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command lambdanio-tx \
    --arguments "(__fish_lambdanio_tx_get_commands)" \
    --no-files
