...
complete --command lambdanio-qt --no-files

# Extract options
function __fish_lambdanioqt_get_options
...
complete \
    --command lambdanio-qt \
    --arguments "(__fish_lambdanioqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c lambdanio-qt \
...
complete \
    --command lambdanio-qt \
    --arguments "(__fish_lambdanioqt_get_options --nofiles)"
