...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('// Copyright (c) The Lambdanio Core developers\n')
    ...
    g.write('#ifndef LAMBDANIO_CHAINPARAMSSEEDS_H\n')
    g.write('#define LAMBDANIO_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the lambdanio network\n')
    ...
    g.write('#endif // LAMBDANIO_CHAINPARAMSSEEDS_H\n')
