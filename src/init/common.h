...
//! @file
//! @brief Common init functions shared by lambdanio-node, lambdanio-wallet, etc.

#ifndef LAMBDANIO_INIT_COMMON_H
#define LAMBDANIO_INIT_COMMON_H
