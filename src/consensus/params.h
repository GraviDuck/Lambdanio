...
#ifndef LAMBDANIO_CONSENSUS_PARAMS_H
#define LAMBDANIO_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Lambdanio Script solution
...
#endif // LAMBDANIO_CONSENSUS_PARAMS_H
