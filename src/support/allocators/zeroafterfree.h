...
#ifndef LAMBDANIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LAMBDANIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LAMBDANIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
