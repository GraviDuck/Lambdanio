...
#ifndef LAMBDANIO_TXGRAPH_H
#define LAMBDANIO_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvinglambdanio.org/t/introduction-to-cluster-linearization/1032
 *
