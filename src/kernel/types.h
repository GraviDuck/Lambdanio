...
//! that can be used internally by functions in the liblambdanio_kernel library,
...
#ifndef LAMBDANIO_KERNEL_TYPES_H
#define LAMBDANIO_KERNEL_TYPES_H
...
#endif // LAMBDANIO_KERNEL_TYPES_H
