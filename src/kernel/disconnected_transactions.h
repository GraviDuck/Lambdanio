...
#ifndef LAMBDANIO_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define LAMBDANIO_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // LAMBDANIO_KERNEL_DISCONNECTED_TRANSACTIONS_H
