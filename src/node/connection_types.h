...
#ifndef LAMBDANIO_NODE_CONNECTION_TYPES_H
#define LAMBDANIO_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/lambdanio-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Lambdanio’s Peer-to-Peer Network")
...
#endif // LAMBDANIO_NODE_CONNECTION_TYPES_H
