...
#ifndef LAMBDANIO_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define LAMBDANIO_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // LAMBDANIO_PRIMITIVES_TRANSACTION_IDENTIFIER_H
