...
{
    // Regression test for lambdanio/lambdanio#34711, lambdanio/lambdanio#34756 where a
...
{
    // Regression test for lambdanio/lambdanio#34777 heap-use-after-free where
...
{
    // Regression test for lambdanio/lambdanio#34782 stack-use-after-return where
