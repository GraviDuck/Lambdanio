...
extern thread_local ThreadContext g_thread_context; // NOLINT(lambdanio-nontrivial-threadlocal)
// Silence nonstandard lambdanio tidy error "Variable with non-trivial destructor
