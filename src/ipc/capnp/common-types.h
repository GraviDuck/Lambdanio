...
#ifndef LAMBDANIO_IPC_CAPNP_COMMON_TYPES_H
#define LAMBDANIO_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between lambdanio processes.
...
//! Functions to serialize / deserialize common lambdanio types.
namespace mp {
...
#endif // LAMBDANIO_IPC_CAPNP_COMMON_TYPES_H
