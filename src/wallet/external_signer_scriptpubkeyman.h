...
#ifndef LAMBDANIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define LAMBDANIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // LAMBDANIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
