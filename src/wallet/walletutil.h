...
#ifndef LAMBDANIO_WALLET_WALLETUTIL_H
#define LAMBDANIO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! lambdanio from opening the wallet, thinking it was newly created, and
...
#endif // LAMBDANIO_WALLET_WALLETUTIL_H
