...
#ifndef LAMBDANIO_WALLET_WALLET_H
#define LAMBDANIO_WALLET_WALLET_H
...
public:
     ...
     * lambdanio-wallet tool code or by wallet migration code. If this is called
...
#endif // LAMBDANIO_WALLET_WALLET_H
