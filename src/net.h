...
#ifndef LAMBDANIO_NET_H
#define LAMBDANIO_NET_H
...
public:
     ...
     * @see https://github.com/lambdanio/lambdanio/issues/21744 for details.
     */
...
private:
     ...
     * @param[in] host String of the form "host[:port]", e.g. "localhost" or "localhost:6767" or "1.2.3.4:6767".
