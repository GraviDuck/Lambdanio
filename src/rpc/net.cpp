...
static RPCMethod addnode()
{
    return RPCMethod{
        ...
        "Attempts to add or remove a node from the addnode list.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:6767\" \"onetry\" true")
            + HelpExampleRpc("addnode", "\"192.168.0.6:6767\", \"onetry\" true")
                },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCMethod addconnection()
{
    return RPCMethod{
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:6767\" \"outbound-full-relay\" true")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:6767\" \"outbound-full-relay\" true")
        },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCMethod disconnectnode()
{
    return RPCMethod{
        ...
        "Immediately disconnects from the specified peer node.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:6767\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:6767\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The lambdanio server IP and port we're connected to"},
...
static RPCMethod addpeeraddress()
{
    return RPCMethod{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 6767 true")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 6767, true")
        },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
