...
#ifndef LAMBDANIO_RPC_PROTOCOL_H
#define LAMBDANIO_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in lambdaniod
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Lambdanio is not connected
...
#endif // LAMBDANIO_RPC_PROTOCOL_H
