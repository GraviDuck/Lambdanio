...
static RPCMethod generatetodescriptor()
{
    return RPCMethod{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated lambdanio to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated lambdanio to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated lambdanio to with:\n"
...
static RPCMethod generateblock()
{
    return RPCMethod{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated lambdanio to."},
...
// NOTE: Unlike wallet RPC (which use LDO values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCMethod getblocktemplate()
{
    return RPCMethod{
        ...
        "    https://github.com/lambdanio/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/lambdanio/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/lambdanio/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/lambdanio/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!lpval.isNull()) {
         ...
         *
         * getblocktemplate is unlikely to be called by lambdanio-cli, so
...
static RPCMethod submitblock()
{
    ...
    return RPCMethod{
        ...
        "See https://en.lambdanio.it/wiki/BIP_0022 for full specification.\n",
        {
