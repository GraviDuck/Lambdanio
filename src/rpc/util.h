...
#ifndef LAMBDANIO_RPC_UTIL_H
#define LAMBDANIO_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting LDO/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1LDO/kvB.
 */
