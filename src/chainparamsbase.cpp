...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("mainnet", 9336);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 19332);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 19332);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 39332);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 9331);
    }
    assert(false);
}
