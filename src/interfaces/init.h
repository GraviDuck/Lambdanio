...
#ifndef LAMBDANIO_INTERFACES_INIT_H
#define LAMBDANIO_INTERFACES_INIT_H
...
//! (lambdanio-gui, lambdanio-node, lambdanio-wallet, lambdaniod, lambdanio-qt) and each
...
#endif // LAMBDANIO_INTERFACES_INIT_H
