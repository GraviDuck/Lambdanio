...
#ifndef LAMBDANIO_INTERFACES_NODE_H
#define LAMBDANIO_INTERFACES_NODE_H
...
//! Top-level interface for a lambdanio node (lambdaniod process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or lambdanio.conf.
...
#endif // LAMBDANIO_INTERFACES_NODE_H
