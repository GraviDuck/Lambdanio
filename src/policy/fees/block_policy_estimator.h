...
#ifndef LAMBDANIO_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define LAMBDANIO_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // LAMBDANIO_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
