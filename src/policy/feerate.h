...
#ifndef LAMBDANIO_POLICY_FEERATE_H
#define LAMBDANIO_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "LDO"; // One formatted unit
const std::string CURRENCY_ATOM = "sat"; // One indivisible minimum value unit

enum class FeeRateFormat {
    LDO_KVB, //!< Use LDO/kvB fee rate unit
...
public:
    ...
    std::string ToString(FeeRateFormat fee_rate_format = FeeRateFormat::LDO_KVB) const;
...
#endif // LAMBDANIO_POLICY_FEERATE_H
