...
#ifndef LAMBDANIO_TXREQUEST_H
#define LAMBDANIO_TXREQUEST_H
 ...
 *   specific transaction. See https://lambdaniocore.org/en/2024/07/03/disclose_already_asked_for.
 */
