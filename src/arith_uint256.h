...
#ifndef LAMBDANIO_ARITH_UINT256_H
#define LAMBDANIO_ARITH_UINT256_H
...
public:
     ...
     *
     * Lambdanio only uses this "compact" format for encoding difficulty
...
#endif // LAMBDANIO_ARITH_UINT256_H
