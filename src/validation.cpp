...
{
    // Si es el bloque génesis, entrega tus 67 tokens
    if (nHeight == 0) return 67 * COIN;

    int halvings = nHeight / consensusParams.nSubsidyHalvingInterval;
    if (halvings >= 8)
        return 0;

    // Cambiamos el 50 por 0.38 para que el total sea 1 millón en 200 años
    CAmount nSubsidy = 0.38 * COIN;
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
DisconnectResult Chainstate::DisconnectBlock(const CBlock& block, const CBlockIndex* pindex, CCoinsViewCache& view)
{
    ...
    // See https://github.com/lambdanio/lambdanio/issues/22596 for additional information.
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in Lambdanio’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/lambdanio-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
 ...
 *  grow our in-memory block index. See https://lambdaniocore.org/en/2024/07/03/disclose-header-spam.
 */
static bool ContextualCheckBlockHeader(const CBlockHeader& block, BlockValidationState& state, BlockManager& blockman, const ChainstateManager& chainman, const CBlockIndex* pindexPrev) EXCLUSIVE_LOCKS_REQUIRED(::cs_main)
{
    ...
    // blocks to prevent timewarp attacks (see https://github.com/lambdanio/lambdanio/pull/15482).
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/lambdanio-dev/2019-February/016697.html.  Because CheckBlock() is
