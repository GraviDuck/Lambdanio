...
#ifndef LAMBDANIO_TEST_SCRIPTNUM10_H
#define LAMBDANIO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Lambdanio Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // LAMBDANIO_TEST_SCRIPTNUM10_H
