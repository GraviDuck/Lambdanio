...
#ifndef LAMBDANIO_TEST_UTIL_SETUP_COMMON_H
#define LAMBDANIO_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/lambdanio/lambdanio/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // LAMBDANIO_TEST_UTIL_SETUP_COMMON_H
