...
{
    BOOST_CHECK(TestSplitHost("www.lambdaniocore.org", "www.lambdaniocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.lambdaniocore.org]", "www.lambdaniocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.lambdaniocore.org:80", "www.lambdaniocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.lambdaniocore.org]:80", "www.lambdaniocore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6767", "127.0.0.1", 6767));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6767", "127.0.0.1", 6767));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6767", "::ffff:127.0.0.1", 6767));
    BOOST_CHECK(TestSplitHost("[::]:6767", "::", 6767));
    BOOST_CHECK(TestSplitHost("::6767", "::6767", 0));
    BOOST_CHECK(TestSplitHost(":6767", "", 6767));
    BOOST_CHECK(TestSplitHost("[]:6767", "", 6767));
    ...
    BOOST_CHECK(TestSplitHost("www.lambdaniocore.org:65536", "www.lambdaniocore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.lambdaniocore.org:0", "www.lambdaniocore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.lambdaniocore.org:", "www.lambdaniocore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6767", "127.0.0.1:6767"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6767", "[::]:6767"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
