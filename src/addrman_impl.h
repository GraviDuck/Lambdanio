...
#ifndef LAMBDANIO_ADDRMAN_IMPL_H
#define LAMBDANIO_ADDRMAN_IMPL_H
 ...
 * see https://lambdaniocore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // LAMBDANIO_ADDRMAN_IMPL_H
