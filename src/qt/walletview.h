...
#ifndef LAMBDANIO_QT_WALLETVIEW_H
#define LAMBDANIO_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a lambdanio wallet, and offers access to
...
#endif // LAMBDANIO_QT_WALLETVIEW_H
