...
{
    // Test regression https://github.com/lambdanio/lambdanio/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/lambdanio-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/lambdanio-core/gui/pull/568.
    // With fListen=false in ~/.config/Lambdanio/Lambdanio-Qt.conf and all else left as default,
    // lambdanio-qt should set both -listen and -listenonion to false and start successfully.
