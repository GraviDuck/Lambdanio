...
//! Entry point for LambdanioApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LambdanioApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LambdanioGUI tests.
void AppTests::guiTests(LambdanioGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LambdanioGUI::consoleShown, this, &AppTests::consoleTests);
