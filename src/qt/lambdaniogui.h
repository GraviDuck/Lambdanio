...
#ifndef LAMBDANIO_QT_LAMBDANIOGUI_H
#define LAMBDANIO_QT_LAMBDANIOGUI_H
...
/**
  Lambdanio GUI main class. This class represents the main window of the Lambdanio UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LambdanioGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LambdanioGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~LambdanioGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a lambdanio wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, LambdanioUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Lambdanio Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(LambdanioUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // LAMBDANIO_QT_LAMBDANIOGUI_H
