...
#ifndef LAMBDANIO_QT_OPTIONSMODEL_H
#define LAMBDANIO_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Lambdanio client.
...
public:
    ...
    LambdanioUnit getDisplayUnit() const { return m_display_lambdanio_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSLDOontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    LambdanioUnit m_display_lambdanio_unit;
...
Q_SIGNALS:
    void displayUnitChanged(LambdanioUnit unit);
...
#endif // LAMBDANIO_QT_OPTIONSMODEL_H
