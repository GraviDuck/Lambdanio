    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The lambdanio-qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of lambdaniod with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
                         ...
                         "Usage: lambdanio-qt [options] [URI]\n\n";
