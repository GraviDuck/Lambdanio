...
#ifndef LAMBDANIO_QT_SENDCOINSENTRY_H
#define LAMBDANIO_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending lambdanios.
 */
...
#endif // LAMBDANIO_QT_SENDCOINSENTRY_H
