...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Επιλέξτε τη διεύθυνση στην οποία θα στείλετε lambdanio</translation>
    </message>
    <message>
        <source>Choose the address to receive coins with</source>
        <translation type="unfinished">Επιλέξτε τη διεύθυνση παραλαβής lambdanio</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αυτές είναι οι Lambdanio διευθύνσεις σας για να στέλνετε πληρωμές. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη πριν στείλετε νομίσματα.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Αυτές είναι οι Lambdanio διευθύνσεις για τη λήψη πληρωμών. Χρησιμοποιήστε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για τη δημιουργία νέας διεύθυνσης.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Προσοχή! Εάν κρυπτογραφήσετε το πορτοφόλι σας και χάσετε τη φράση πρόσβασης, θα &lt;b&gt; ΧΑΣΕΤΕ ΟΛΑ ΤΑ LAMBDANIO ΣΑΣ&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα lambdanios σου από κλοπή από κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Στείλτε κέρματα σε μια διεύθυνση Lambdanio</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Υπογράψτε μηνύματα με τις διευθύνσεις Lambdanio σας για να αποδείξετε ότι σας ανήκουν</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Επαληθεύστε μηνύματα για να βεβαιωθείτε ότι υπογράφηκαν με τις καθορισμένες διευθύνσεις Lambdanio</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις lambdanio: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed Lambdanio</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση μερικώς υπογεγραμμένης συναλλαγής Lambdanio από το πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε ένα lambdanio: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφανίστε το μήνυμα βοήθειας του %1 για να δείτε μια λίστα με τις διαθέσιμες επιλογές της γραμμής εντολών του Lambdanio</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation type="unfinished">
            ...
            <numerusform>%n ενεργές συνδέσεις στο δίκτυο Lambdanio.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση "%1" δεν είναι έγκυρη Lambdanio διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας block του Lambdanio.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η προσπάθεια να δαπανήσετε lambdanios που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε το lambdanio URI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Πλήρης διαδρομή ενός script συμβατού με το %1 (π.χ.: C:\Downloads\hwi.exe ή /Users/you/Downloads/hwi.py). Προσοχή: ένα κακόβουλο λογισμικό μπορεί να κλέψει τα lambdanio σας!</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Ανοίξτε αυτόματα τη πόρτα του Lambdanio client στο router. Αυτό λειτουργεί μόνο όταν το router σας υποστηρίζει PCP ή NAT-PMP και είναι ενεργοποιημένο. Η εξωτερική πόρτα μπορεί να είναι τυχαία.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σύνδεση στο δίκτυο Lambdanio μέσω SOCKS5 proxy.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Διαλέξτε την προεπιλεγμένη υποδιαίρεση που θα εμφανίζεται όταν στέλνετε lambdanios.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Συνδεθείτε στο δίκτυο Lambdanio μέσω ξεχωριστού SOCKS5 proxy για τις υπηρεσίες onion του Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο Lambdanio μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Διευθύνσεις δικτύου που χρησιμοποιεί αυτήν τη στιγμή ο Lambdanio κόμβος σας για να επικοινωνεί με άλλους κόμβους.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου Lambdanio.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Αποστολή lambdanio</translation>
    </message>
    <message>
...
Σημείωση: Εφόσον η χρέωση υπολογίζεται ανά byte, ένας ρυθμός χρέωσης των «100 satoshis ανά kvB» για μέγεθος συναλλαγής 500 ψηφιακών bytes (το μισό του 1 kvB) θα απέφερε χρέωση μόλις 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα blocks, οι εξορύκτες καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνεται όταν θα υπάρχει μεγαλύτερη ζήτηση για συναλλαγές lambdanio από ότι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Δημιουργεί μια συναλλαγή Lambdanio με μερική υπογραφή (PSBT) για χρήση με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα hardware πορτοφόλι συμβατό με PSBT.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Παρακαλούμε, ελέγξτε την πρόταση συναλλαγής. Θα παραχθεί μια συναλλαγή Lambdanio με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished"> Επιβεβαιώστε την αποστολή lambdanio</translation>
    </message>
    <message numerus="yes">
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Σφάλμα: Η έκδοση του αρχείου dump δεν υποστηρίζεται. Αυτή η έκδοση του lambdanio-wallet υποστηρίζει αρχεία dump μόνο της έκδοσης 1. Δόθηκε αρχείο dump έκδοσης %s.</translation>
    </message>
    <message>
