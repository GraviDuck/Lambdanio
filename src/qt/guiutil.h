...
#ifndef LAMBDANIO_QT_GUIUTIL_H
#define LAMBDANIO_QT_GUIUTIL_H
...
/** Utility functions used by the Lambdanio Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "lambdanio:" URI into recipient object, return true on successful parsing
