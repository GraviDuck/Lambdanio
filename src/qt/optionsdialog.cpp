      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->lambdanioAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->lambdanioAtStartup);
    ...
    ui->lambdanioAtStartup->setToolTip(ui->lambdanioAtStartup->toolTip().arg(CLIENT_NAME));
    ui->lambdanioAtStartup->setText(ui->lambdanioAtStartup->text().arg(CLIENT_NAME));

    ui->openLambdanioConfButton->setToolTip(ui->openLambdanioConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new LambdanioUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->lambdanioAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSLDOontrols);
...
void OptionsDialog::on_openLambdanioConfButton_clicked()
{
