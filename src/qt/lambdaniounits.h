...
#ifndef LAMBDANIO_QT_LAMBDANIOUNITS_H
#define LAMBDANIO_QT_LAMBDANIOUNITS_H
...
/** Lambdanio unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LambdanioUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LambdanioUnits(QObject *parent);

    /** Lambdanio units.
      @note Source: https://en.lambdanio.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        LDO,
        mLDO,
