...
#ifndef LAMBDANIO_QT_RECEIVECOINSDIALOG_H
#define LAMBDANIO_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of lambdanios */
...
#endif // LAMBDANIO_QT_RECEIVECOINSDIALOG_H
