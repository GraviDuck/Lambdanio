...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = LambdanioUnits::formatWithUnit(unit, amount, true, LambdanioUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    LambdanioUnit unit{LambdanioUnit::LDO};
...
{
    LambdanioUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(LambdanioUnits::formatWithPrivacy(unit, balances.balance, LambdanioUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(LambdanioUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, LambdanioUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(LambdanioUnits::formatWithPrivacy(unit, balances.immature_balance, LambdanioUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(LambdanioUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, LambdanioUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("LDO")
    updateDisplayUnit();
}
