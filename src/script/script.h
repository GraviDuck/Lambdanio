...
#ifndef LAMBDANIO_SCRIPT_SCRIPT_H
#define LAMBDANIO_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Lambdanio always counted CHECKMULTISIGs
...
#endif // LAMBDANIO_SCRIPT_SCRIPT_H
