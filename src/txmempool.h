...
#ifndef LAMBDANIO_TXMEMPOOL_H
#define LAMBDANIO_TXMEMPOOL_H
 ...
 * Lambdanio-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Lambdanio-specific parts of mempool
