...
// Copyright 2015 Lambdanio Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef LAMBDANIO_UNIVALUE_INCLUDE_UNIVALUE_H
#define LAMBDANIO_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // LAMBDANIO_UNIVALUE_INCLUDE_UNIVALUE_H
