...
//! that can be used internally by functions in the liblambdanio_common library,
...
#ifndef LAMBDANIO_COMMON_TYPES_H
#define LAMBDANIO_COMMON_TYPES_H
...
#endif // LAMBDANIO_COMMON_TYPES_H
