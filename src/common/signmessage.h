...
#ifndef LAMBDANIO_COMMON_SIGNMESSAGE_H
#define LAMBDANIO_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's lambdanio address, it must refer to a public key.
...
#endif // LAMBDANIO_COMMON_SIGNMESSAGE_H
