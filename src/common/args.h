...
#ifndef LAMBDANIO_COMMON_ARGS_H
#define LAMBDANIO_COMMON_ARGS_H
...
extern const char * const LAMBDANIO_CONF_FILENAME;
extern const char * const LAMBDANIO_SETTINGS_FILENAME;
