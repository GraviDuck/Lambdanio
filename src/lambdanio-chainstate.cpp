...
//
// The lambdanio-chainstate executable serves to surface the dependencies required
// by a program wishing to use Lambdanio Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from Lambdanio Core's coding style.
//
// It is part of the liblambdaniokernel project.
