...
"""
Test starting lambdaniod with -bind and/or -bind=...=onion, confirm that
...
class BindExtraTest(LambdanioTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that lambdaniod has bound on "::1" (for RPC) and "::" (for P2P).
