...
class TxnMallTest(LambdanioTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 LDO:
        ...
        # First: use raw transaction API to send 1240 LDO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 LDO coin each
        ...
        # Node0's balance should be starting balance, plus 50LDO for another
        ...
        # Node0's total balance should be starting balance, plus 100LDO for
