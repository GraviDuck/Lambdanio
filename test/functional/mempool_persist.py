...
By default, lambdaniod will dump mempool on shutdown and
...
class MempoolPersistTest(LambdanioTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent lambdaniod from writing mempool.dat to disk. Verify that `savemempool` fails")
