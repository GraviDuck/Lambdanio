...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The lambdaniod node closes feeler connections as soon as a version
...
class P2PAddConnections(LambdanioTestFramework):
    ...
    def run_test(self):
        ...
        # lambdaniod behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that lambdaniod sends its own version prior to processing
