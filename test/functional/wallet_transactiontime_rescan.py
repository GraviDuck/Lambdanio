...
class TransactionTimeRescanTest(LambdanioTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine LDO and create transactions
        ...
        # generate some ldo to create transactions and check blockcount
        ...
        # send 10 ldo to user's first watch-only address
        self.log.info('Send 10 ldo to user')
        ...
        # send 5 ldo to our second watch-only address
        self.log.info('Send 5 ldo to user')
        ...
        # send 1 ldo to our third watch-only address
        self.log.info('Send 1 ldo to user')
