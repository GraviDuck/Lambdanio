...
Verify that a lambdaniod node can use an external signer command.
...
class RPCSignerTest(LambdanioTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart lambdaniod with -signer=<cmd>',
