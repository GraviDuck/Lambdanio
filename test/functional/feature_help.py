...
"""Verify that starting lambdanio with -h works as expected."""

from test_framework.test_framework import LambdanioTestFramework
from test_framework.util import assert_equal

class HelpTest(LambdanioTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lambdanio with -h for help text")
        ...
        self.log.info("Start lambdanio with -version for version information")
        ...
        self.log.info("Start lambdaniod with -fakearg to make sure it does not start")
