...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/lambdanio/lambdanio/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(LambdanioTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/lambdanio/lambdanio/blob/master/doc/tracing.md#tracepoint-validationblock_connected
