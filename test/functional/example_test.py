...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LambdanioTestFramework
    pass


class ExampleTest(LambdanioTestFramework):
    # Each functional test is a subclass of the LambdanioTestFramework class.
    ...
    def custom_method(self):
        ...
        LambdanioTestFramework class so other tests can use it."""
