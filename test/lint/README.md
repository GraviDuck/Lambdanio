...
maintained:
* for `src/crc32c`: https://github.com/lambdanio-core/crc32c-subtree.git (branch lambdanio-fork)
* for `src/crypto/ctaes`: https://github.com/lambdanio-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/lambdanio-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/lambdanio-core/leveldb-subtree.git (branch lambdanio-fork)
* for `src/minisketch`: https://github.com/lambdanio-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/lambdanio-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/lambdanio-core/secp256k1.git
```
