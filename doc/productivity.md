...
```sh
cmake --build build --target lambdaniod lambdanio-cli
cmake --build build --target lambdanio-qt
cmake --build build --target bench_lambdanio
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:lambdanio/lambdanio.git
```
...
> e.g. github.com/lambdanio/lambdanio.git or for the GUI github.com/lambdanio-core/gui
