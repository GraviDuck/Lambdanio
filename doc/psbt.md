# PSBT Howto for Lambdanio Core

Since Lambdanio Core 0.17, an RPC interface exists for Partially Signed Lambdanio
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/lambdanio/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Lambdanio transactions that are not fully signed
...
#### Multisig with multiple Lambdanio Core instances
