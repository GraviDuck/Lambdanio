...
Assumeutxo is a feature that allows fast bootstrapping of a validating lambdaniod
instance.
...
```
$ lambdanio-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ lambdanio-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
