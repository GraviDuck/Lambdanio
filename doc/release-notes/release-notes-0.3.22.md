Download URL: https://sourceforge.net/projects/lambdanio/files/Lambdanio/lambdanio-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LDO fee schedule (users still pay 0.01 LDO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #lambdanio00 - #lambdanio99
