Lambdanio version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lambdanio/files/Lambdanio/lambdanio-0.5.4/
...
http://gitorious.org/lambdanio/lambdaniod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lambdanio-Qt notifications under Growl 1.3.
Increase required age of Lambdanio-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLambdanio properly when installing Lambdanio-Qt over it. (Windows)
