Lambdanio-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lambdanio/files/Lambdanio/lambdanio-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lambdanio
...
New/changed settings (command-line or lambdanio.conf file)
--------------------------------------------------------
