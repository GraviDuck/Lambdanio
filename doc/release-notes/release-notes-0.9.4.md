Lambdanio Core version 0.9.4 is now available from:

  https://lambdanio.org/bin/0.9.4/
...
this update is incompatible with the Lambdanio system and could lead to consensus
forks.

Lambdanio Core released binaries from https://lambdanio.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lambdanio/+archive/ubuntu/lambdanio
- A third-party or self-compiled Lambdanio Core

upgrade to Lambdanio Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
