Lambdanio Core version *0.15.0.1* is now available from:

  <https://lambdanio.org/bin/lambdanio-core-0.15.0.1/>

and

  <https://lambdaniocore.org/bin/lambdanio-core-0.15.0.1/>
