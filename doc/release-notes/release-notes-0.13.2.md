Lambdanio Core version 0.13.2 is now available from:

  <https://lambdanio.org/bin/lambdanio-core-0.13.2/>
...
- #8908 `4a974b2` Update lambdanio-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow lambdanio-tx to create v2 transactions (ldodrak)
