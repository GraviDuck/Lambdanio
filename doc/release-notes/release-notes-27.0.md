Lambdanio Core version 27.0 is now available from:

  <https://lambdaniocore.org/bin/lambdanio-core-27.0/>
...
liblambdanioconsensus
-------------------

- liblambdanioconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, liblambdaniokernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Lambdanio Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Lambdanio Core would
