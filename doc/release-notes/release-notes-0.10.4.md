Lambdanio Core version 0.10.4 is now available from:

  <https://lambdanio.org/bin/lambdanio-core-0.10.4/>
...
- #6953 `43c2789` Split lambdanio-tx into its own package
- #6953 `dfe0d4d` Include lambdanio-tx binary on Debian/Ubuntu
