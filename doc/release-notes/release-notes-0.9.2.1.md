Lambdanio Core version 0.9.2.1 is now available from:

  https://lambdanio.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LDO to 0.01 LDO
...
- Fix "Start lambdanio on system login"
