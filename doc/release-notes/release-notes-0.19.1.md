...
Lambdanio Core version 0.19.1 is now available from:

  <https://lambdaniocore.org/bin/lambdanio-core-0.19.1/>
...
From Lambdanio Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Lambdanio Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Lambdanio Core does not yet change appearance when
...
- #17488 fix "lambdaniod already running" warnings on macOS (fanquake)
