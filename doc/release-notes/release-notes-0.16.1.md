Lambdanio Core version 0.16.1 is now available from:

  <https://lambdaniocore.org/bin/lambdanio-core-0.16.1/>
...
- #12843 `df38b13` Test starting lambdaniod with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure lambdaniod processes are cleaned up when tests end (sdaftuar)
