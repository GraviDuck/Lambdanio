Lambdanio Core version 0.10.3 is now available from:

  <https://lambdanio.org/bin/lambdanio-core-0.10.3/>
...
(see https://github.com/lambdanio/lambdanio/pull/6793, as well as the 0.11.0
