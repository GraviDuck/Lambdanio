Lambdanio Core version *0.15.2* is now available from:

  <https://lambdaniocore.org/bin/lambdanio-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in lambdanio-tx (TheBlueMatt)
