...
Lambdanio Core version v30.1 is now available from:

  <https://lambdaniocore.org/bin/lambdanio-core-30.1/>
...
- #33229 multiprocess: Don't require lambdanio -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.lambdanio.dashjr-list-of-p2p-nodes.us
