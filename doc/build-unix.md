UNIX BUILD NOTES
====================
Some notes on how to build Lambdanio Core in Unix.
...
memory available when compiling Lambdanio Core. On systems with less, gcc can be
...
To build Lambdanio Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Lambdanio Core can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/lambdaniod
    ./build/bin/lambdanio help
