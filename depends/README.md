...
Lambdanio Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Lambdanio Core

**When configuring Lambdanio Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Lambdanio Core:
...
variables will be set when generating the Lambdanio Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
